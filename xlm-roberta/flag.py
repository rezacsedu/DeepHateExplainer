...
def get_parser():
    ...
    parser.add_argument("--classes", default=5, type=int, metavar='N', help='Number of output classes')
    parser.add_argument("--training_file", default='../input/hate_speech_folds.csv',type=str, help='Path to train file')
    parser.add_argument("-do", "--dropout", type=float, default=0.1,help="dropout")
    parser.add_argument("-m_path", "--model_path", type=str, default='../store_model/model.bin',help="Save best model")
