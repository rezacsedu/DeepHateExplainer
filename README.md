...
<p align="justify">Code and supplementary materials for our paper "DeepHateExplainer: Explainable Hate Speech Detection in Under-resourced Bengali Language" (link: https://arxiv.org/pdf/2012.14353.pdf). This repo will be updated with more reproducable resources, e.g., models, notebooks, etc.</p>
