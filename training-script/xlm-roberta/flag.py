...
def get_parser():
    ...
    parser.add_argument("-do", "--dropout", type=float, default=0.3,help="dropout")
    parser.add_argument("-m_path", "--model_path", type=str, default='../DeepHateLingo/training-script/xlm-roberta/store_model/',help="Save best model")
