...
# LOGGER's
LOGGER_DEBUG_FILE = '../DeepHateLingo/training-script/bangla-bert-base/logs/debug.log'
LOGGER_INFO_FILE = '../DeepHateLingo/training-script/bangla-bert-base/logs/info.log'
LOGGER_ERROR_FILE = '../DeepHateLingo/training-script/bangla-bert-base/logs/error.log'
